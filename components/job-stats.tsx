import { Briefcase, Clock, Users2, DollarSign } from "lucide-react"
  ...
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">$105,240</div>
          <p className="text-xs text-muted-foreground">For all active positions</p>
        </CardContent>
      </Card>
    </div>
  )
